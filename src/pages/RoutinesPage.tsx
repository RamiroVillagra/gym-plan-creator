...
import { Plus, Trash2, ChevronDown, ChevronUp, Pencil, Folder, FolderOpen } from "lucide-react";
...
export default function RoutinesPage() {
  ...
  // Compute folders
  const folders = [...new Set(routines?.map(r => (r as any).folder).filter(Boolean) ?? [])].sort() as string[];
  const unfolderedRoutines = routines?.filter(r => !(r as any).folder) ?? [];
          ...
          <DialogContent>
            ...
            <div className="space-y-4 mt-4">
              ...
              <div>
                ...
                <Input placeholder="Ej: Fuerza, Hipertrofia..." value={routineFolder} onChange={e => setRoutineFolder(e.target.value)} list="folder-suggestions" />
        ...
        <DialogContent>
          ...
          <div className="space-y-4 mt-4">
            ...
            <div>
              ...
              <Input placeholder="Ej: Fuerza, Hipertrofia..." value={editFolder} onChange={e => setEditFolder(e.target.value)} list="folder-suggestions-edit" />
